...
| read.persistence.enabled | bool | `false` | Enable creating PVCs for the read cache |
...
| write.persistence.enabled | bool | `false` | Enable creating PVCs which is required when using boltdb-shipper |
